...
interface BookProps {
    sortedReadBooks : iBook[];
}

const ReadBooks = ({ sortedReadBooks  }: BookProps) => {
    return (
        <div className="space-y-3">
            {sortedReadBooks .length > 0 ? (
                sortedReadBooks .map((r) => (
                    <div
                        key={r.bookId}
                    ...
                    >
                            ...
                            <div className="flex flex-1 flex-col justify-between">
                                ...
                                <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    <span className="flex items-center gap-1 text-[8px] text-[#13131399]">
                                        ...
                                        Year of Publishing {r.yearOfPublishing}
                                    </span>
                                </div>
                        ...
                        <div className="mt-3 flex items-center justify-between border-t border-[#1313131A] pt-2">
                            ...
                            <Link href={`/${r.bookId}`}><button className="flex items-center gap-1 rounded-full bg-[#16A34A] px-3 py-1.5 text-[8px] font-semibold text-white transition hover:bg-[#15803D]">
                                <FaEye size={8} />
                                View Details
                            </button></Link>
                        </div>
